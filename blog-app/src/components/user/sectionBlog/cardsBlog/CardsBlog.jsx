const CardsBlog = () => {
  return (
    <div className=" my-10 mx-auto dark:bg-gray-800 dark:text-gray-100">
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-4 sm:grid-cols-2">
        <div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-96 dark:bg-gray-500">
          <img className="absolute left-0 top-0 w-full h-full rounded-md z-0 object-cover" src="https://source.unsplash.com/random/240x320" alt="" />
        ...
        <div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-96 dark:bg-gray-500">
          <img className="absolute left-0 top-0 w-full h-full rounded-md z-0 object-cover" src="https://source.unsplash.com/random/241x320" alt="" />
          <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b dark:via-transparent dark:from-gray-900 dark:to-gray-900"></div>
          <div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
            <a
              rel="noopener noreferrer"
        ...
        <div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-96 dark:bg-gray-500">
          <img className="absolute left-0 top-0 w-full h-full rounded-md z-0 object-cover" src="https://source.unsplash.com/random/242x320" alt="" />
          <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b dark:via-transparent dark:from-gray-900 dark:to-gray-900"></div>
          <div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
            <a
              rel="noopener noreferrer"
        ...
        <div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-96 dark:bg-gray-500">
          <img className="absolute left-0 top-0 w-full h-full rounded-md z-0 object-cover" src="https://source.unsplash.com/random/243x320" alt="" />
          <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b dark:via-transparent dark:from-gray-900 dark:to-gray-900"></div>
          <div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
            <a
              rel="noopener noreferrer"
