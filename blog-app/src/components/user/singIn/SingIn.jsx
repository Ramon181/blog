...
const SingIn = ({ setOpenSingIn }) => {
  ...
  return (
    <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
      <form onSubmit={handleSubmit} class="w-full px-6 py-8 md:px-8">
        ...
        <div class="mt-8">
          <button
            type="submit"
            class="bg-white tracking-wide text-gray-800 font-bold w-full rounded border-b-2 border-blue-500 hover:border-blue-600 hover:bg-blue-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center"
          >
            <span class="mx-auto">Iniciar Session</span>
          </button>
        </div>
